...
anno_dir = os.path.join(data_dir, 'Annotations_trainval')
image_dir = os.path.join(data_dir, 'JPEGImages_trainval')
...
train_txt = os.path.join(data_dir, 'ImageSets_trainval/Main/train.txt')
...
test_txt = os.path.join(data_dir, 'ImageSets_trainval/Main/val.txt')

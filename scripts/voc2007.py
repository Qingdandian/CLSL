...
# data_dir = 'datasets/VOC2007'  # default
data_dir = '/public/home/hpc2307070100001/Datasets/all_data/datasets/VOC2007'
# data_dir = 'E:/做实验时用到的数据集/voc/datasets/VOC2007'
anno_dir = os.path.join(data_dir, 'Annotations')
image_dir = os.path.join(data_dir, 'JPEGImages')
# save_dir = 'data/voc2007'  # default
save_dir = '/public/home/hpc2307070100001/Datasets/all_data/data/voc2007'
# save_dir = 'E:/做实验时用到的数据集/voc/data/voc2007'
...
# if partial == True and partial < 1.:
#     rand_tensor = torch.rand(len(train_imgIds), len(classnames))
#     mask = (rand_tensor < partial)
...
for img_id in train_imgIds:
    ...
    # if partial == True and partial < 1.:
    #     masked = - torch.ones((1, len(classnames)), dtype=torch.long)
    #     target = mask[index] * target + (1 - self.mask[index]) * masked

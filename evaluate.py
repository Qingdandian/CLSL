...
if __name__ == "__main__":
    ...
    parser.add_argument('--exp-dir', type=str, default='experiments/sarlp_voc2007/exp2')  # experiments/mlic_v3_voc2007/exp91  experiments/SALRL2_voc2007/exp2
    ...
    cfg = yaml.safe_load(open(cfg_path, 'r', encoding=encoding))
